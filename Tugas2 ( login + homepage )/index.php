...
<form action="login.php" method="post">
		<div class="container">
			<h1>Login Form</h1>
				...
				<button value="save" name="cmd" id="cmd">Login</button>				
		</div>
</form>
<button onclick="window.location.href='/AIJ/Tugas2%20(%20login%20+%20homepage%20)/register.php'" class="register">Register</button>
</body>
</html>